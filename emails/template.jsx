...
export default function EmailTemplate({
  ...
  // Ensure data has proper default values to prevent undefined errors
  const safeData = {
        ...
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            <Text style={styles.text}>
              Here&rsquo;s your financial summary for {safeData.month}:
            </Text>
            ...
            <Section style={styles.statsContainer}>
              ...
              <div style={styles.stat}>
                ...
                <Text style={styles.heading}>
                  ${safeData.stats.totalIncome - safeData.stats.totalExpenses}
                </Text>
              </div>
            </Section>
      ...
      <Html>
        ...
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            <Text style={styles.text}>Hello {userName},</Text>
            <Text style={styles.text}>
              You&rsquo;ve used {safeData.percentageUsed.toFixed(1)}% of your
              monthly budget for {safeData.accountName}.
            </Text>
            <Section style={styles.statsContainer}>
              <div style={styles.stat}>
              ...
              <div style={styles.stat}>
                ...
                <Text style={styles.heading}>
                  ${(safeData.budgetAmount - safeData.totalExpenses).toFixed(1)}
                </Text>
              </div>
            </Section>
          </Container>
